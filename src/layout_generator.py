...
class LayoutGenerator:
    ...
    def generate_layout(self, venture_type, area, dimensions, user_prompt):
        ...
        Your task is to design a functional, professional, and aesthetic layout for a {venture_type} with an area of {area} sq ft.
        ...
        3. SVG STYLING:
           ...
           - Add subtle 1px dashed lines for furniture or area suggestions (tables, desks).
